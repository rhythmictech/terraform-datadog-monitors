...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:elasticsearch", "created-by:terraform"], var.es_cluster_status_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:elasticsearch", "created-by:terraform"], var.diskspace_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:elasticsearch", "created-by:terraform"], var.cpu_extra_tags)
}
