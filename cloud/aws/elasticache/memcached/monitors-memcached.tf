...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:elasticache-memcached", "created-by:terraform", "engine:memcached"], var.get_hits_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:elasticache-memcached", "created-by:terraform", "engine:memcached"], var.cpu_high_extra_tags)
}
