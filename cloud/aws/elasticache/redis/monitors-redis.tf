...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:elasticache-redis", "created-by:terraform", "engine:redis"], var.cache_hits_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:elasticache-redis", "created-by:terraform", "engine:redis"], var.cpu_high_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:elasticache-redis", "created-by:terraform", "engine:redis"], var.replication_lag_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:elasticache-redis", "created-by:terraform", "engine:redis"], var.commands_extra_tags)
}
