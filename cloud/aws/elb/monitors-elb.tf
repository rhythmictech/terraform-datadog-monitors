...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:elb", "created-by:terraform"], var.elb_no_healthy_instance_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:elb", "created-by:terraform"], var.elb_4xx_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:elb", "created-by:terraform"], var.elb_5xx_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:elb", "created-by:terraform"], var.elb_backend_4xx_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:elb", "created-by:terraform"], var.elb_backend_5xx_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:elb", "created-by:terraform"], var.elb_backend_latency_extra_tags)
}
