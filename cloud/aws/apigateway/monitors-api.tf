...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:apigateway", "created-by:terraform"], var.latency_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:apigateway", "created-by:terraform"], var.http_5xx_requests_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:apigateway", "created-by:terraform"], var.http_4xx_requests_extra_tags)
}
