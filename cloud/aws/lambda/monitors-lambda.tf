...
resource "datadog_monitor" "pct_errors" {
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:lambda", "created-by:terraform"], var.pct_errors_extra_tags)
}
...
resource "datadog_monitor" "errors" {
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:lambda", "created-by:terraform"], var.errors_extra_tags)
}
...
resource "datadog_monitor" "throttles" {
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:lambda", "created-by:terraform"], var.throttles_extra_tags)
}
...
resource "datadog_monitor" "invocations" {
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:lambda", "created-by:terraform"], var.invocations_extra_tags)
}
