...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:alb", "created-by:terraform"], var.alb_no_healthy_instances_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:alb", "created-by:terraform"], var.latency_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:alb", "created-by:terraform"], var.httpcode_alb_5xx_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:alb", "created-by:terraform"], var.httpcode_alb_4xx_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:alb", "created-by:terraform"], var.httpcode_target_5xx_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:alb", "created-by:terraform"], var.httpcode_target_4xx_extra_tags)
}
