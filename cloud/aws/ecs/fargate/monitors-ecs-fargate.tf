...
EOQ
  ...
  include_tags = true
  tags         = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:ecs_fargate", "created-by:terraform", "category:service"], var.service_check_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:ecs_fargate", "created-by:terraform"], var.cpu_utilization_extra_tags)
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:ecs_fargate", "created-by:terraform"], var.memory_utilization_extra_tags)
