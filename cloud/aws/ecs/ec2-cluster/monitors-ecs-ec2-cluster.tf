...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:ecs", "created-by:terraform", "category:agent"], var.agent_status_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:ecs", "created-by:terraform", "category:cluster"], var.cluster_cpu_utilization_extra_tags)
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:aws", "resource:ecs", "created-by:terraform", "category:cluster"], var.cluster_memory_reservation_extra_tags)
}
