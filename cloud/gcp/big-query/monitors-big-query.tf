...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:gcp", "resource:big-query", "created-by:terraform"], var.concurrent_queries_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:gcp", "resource:big-query", "created-by:terraform"], var.execution_time_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:gcp", "resource:big-query", "created-by:terraform"], var.scanned_bytes_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:gcp", "resource:big-query", "created-by:terraform"], var.scanned_bytes_billed_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:gcp", "resource:big-query", "created-by:terraform"], var.available_slots_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:gcp", "resource:big-query", "created-by:terraform"], var.stored_bytes_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:gcp", "resource:big-query", "created-by:terraform"], var.table_count_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:gcp", "resource:big-query", "created-by:terraform"], var.uploaded_bytes_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:gcp", "resource:big-query", "created-by:terraform"], var.uploaded_bytes_billed_extra_tags)
}
