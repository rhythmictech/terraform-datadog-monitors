...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:gcp", "resource:lb", "created-by:terraform"], var.error_rate_4xx_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:gcp", "resource:lb", "created-by:terraform"], var.error_rate_5xx_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:gcp", "resource:lb", "created-by:terraform"], var.backend_latency_service_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:gcp", "resource:lb", "created-by:terraform"], var.backend_latency_bucket_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:gcp", "resource:lb", "created-by:terraform"], var.request_count_extra_tags)
}
