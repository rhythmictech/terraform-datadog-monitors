...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:gcp", "resource:pubsub", "category:subscription", "created-by:terraform"], var.oldest_unacked_message_age_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:gcp", "resource:pubsub", "category:subscription", "created-by:terraform"], var.subscription_push_latency_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:gcp", "resource:pubsub", "category:subscription", "created-by:terraform"], var.subscription_push_latency_anomaly_extra_tags)
}