...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:app-gateway", "created-by:terraform"], var.status_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:app-gateway", "created-by:terraform"], var.total_requests_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:app-gateway", "created-by:terraform"], var.appgateway_backend_connect_time_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:app-gateway", "created-by:terraform"], var.appgateway_failed_requests_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:app-gateway", "created-by:terraform"], var.appgateway_unhealthy_host_ratio_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:app-gateway", "created-by:terraform"], var.appgateway_http_4xx_errors_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:app-gateway", "created-by:terraform"], var.appgateway_http_5xx_errors_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:app-gateway", "created-by:terraform"], var.appgateway_backend_http_4xx_errors_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:app-gateway", "created-by:terraform"], var.appgateway_backend_http_5xx_errors_extra_tags)
}
