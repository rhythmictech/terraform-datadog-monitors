...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:mysql", "created-by:terraform"], var.cpu_usage_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:mysql", "created-by:terraform"], var.free_storage_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:mysql", "created-by:terraform"], var.io_consumption_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:mysql", "created-by:terraform"], var.memory_usage_extra_tags)
}
