...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:cosmos_db", "created-by:terraform"], var.status_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:cosmos_db", "created-by:terraform"], var.cosmos_db_4xx_request_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:cosmos_db", "created-by:terraform"], var.cosmos_db_5xx_request_rate_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:cosmos_db", "created-by:terraform"], var.cosmos_db_scaling_extra_tags)
}
