...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:servicebus", "created-by:terraform"], var.status_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:servicebus", "created-by:terraform"], var.no_active_connections_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:servicebus", "created-by:terraform"], var.user_errors_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:servicebus", "created-by:terraform"], var.server_errors_extra_tags)
}
