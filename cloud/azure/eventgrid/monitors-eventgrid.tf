...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:eventgrid", "created-by:terraform"], var.no_successful_message_rate_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:eventgrid", "created-by:terraform"], var.failed_messages_rate_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:eventgrid", "created-by:terraform"], var.unmatched_events_rate_extra_tags)
}
