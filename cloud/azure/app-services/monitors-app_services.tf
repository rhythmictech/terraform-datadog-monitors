...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:app-services", "created-by:terraform"], var.response_time_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:app-services", "created-by:terraform"], var.memory_usage_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:app-services", "created-by:terraform"], var.http_5xx_requests_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:app-services", "created-by:terraform"], var.http_4xx_requests_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:app-services", "created-by:terraform"], var.http_successful_requests_extra_tags)
}
...
EOQ
  ...
  timeout_h           = var.timeout_h
  include_tags        = true
  tags                = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:app-services", "created-by:terraform"], var.status_extra_tags)
