...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:iothubs", "created-by:terraform"], var.failed_jobs_rate_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:iothubs", "created-by:terraform"], var.failed_listjobs_rate_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:iothubs", "created-by:terraform"], var.failed_queryjobs_rate_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:iothubs", "created-by:terraform"], var.status_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:iothubs", "created-by:terraform"], var.total_devices_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:iothubs", "created-by:terraform"], var.failed_c2d_methods_rate_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:iothubs", "created-by:terraform"], var.failed_c2d_twin_read_rate_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:iothubs", "created-by:terraform"], var.failed_c2d_twin_update_rate_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:iothubs", "created-by:terraform"], var.failed_d2c_twin_read_rate_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:iothubs", "created-by:terraform"], var.failed_d2c_twin_update_rate_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:iothubs", "created-by:terraform"], var.dropped_d2c_telemetry_egress_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:iothubs", "created-by:terraform"], var.orphaned_d2c_telemetry_egress_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:iothubs", "created-by:terraform"], var.invalid_d2c_telemetry_egress_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:iothubs", "created-by:terraform"], var.too_many_d2c_telemetry_ingress_nosent_extra_tags)
}
