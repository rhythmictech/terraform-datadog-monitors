...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:azure_functions", "created-by:terraform"], var.http_5xx_errors_rate_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:azure_functions", "created-by:terraform"], var.high_connections_count_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:cloud", "provider:azure", "resource:azure_functions", "created-by:terraform"], var.high_threads_count_extra_tags)
}
