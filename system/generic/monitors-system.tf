...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:system", "provider:system-check", "resource:generic", "created-by:terraform"], var.cpu_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:system", "provider:system-core", "resource:generic", "created-by:terraform"], var.load_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:system", "provider:disk", "resource:generic", "created-by:terraform"], var.disk_space_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:system", "provider:disk", "resource:generic", "created-by:terraform"], var.disk_space_forecast_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:system", "provider:disk", "resource:generic", "created-by:terraform"], var.disk_inodes_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:system", "provider:system-check", "resource:generic", "created-by:terraform"], var.memory_extra_tags)
}
