...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:network", "provider:tls", "resource:webcheck", "created-by:terraform"], var.cannot_connect_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:network", "provider:tls", "resource:tls-certificate", "created-by:terraform"], var.invalid_tls_certificate_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:network", "provider:tls", "resource:tls-certificate", "created-by:terraform"], var.tls_certificate_expiration_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:network", "provider:tls", "resource:tls-certificate", "created-by:terraform"], var.certificate_expiration_date_extra_tags)
}