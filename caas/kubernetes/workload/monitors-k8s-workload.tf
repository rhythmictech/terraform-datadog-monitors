...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:caas", "provider:kubernetes", "resource:kubernetes-workload", "created-by:terraform"], var.job_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:caas", "provider:kubernetes", "resource:kubernetes-workload", "created-by:terraform"], var.cronjob_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:caas", "provider:kubernetes", "resource:kubernetes-workload", "created-by:terraform"], var.replica_available_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:caas", "provider:kubernetes", "resource:kubernetes-workload", "created-by:terraform"], var.replica_ready_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:caas", "provider:kubernetes", "resource:kubernetes-workload", "created-by:terraform"], var.replica_current_extra_tags)
}
