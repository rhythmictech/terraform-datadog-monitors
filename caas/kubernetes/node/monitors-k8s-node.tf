...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:caas", "provider:kubernetes", "resource:kubernetes-node", "created-by:terraform"], var.disk_pressure_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:caas", "provider:kubernetes", "resource:kubernetes-node", "created-by:terraform"], var.disk_out_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:caas", "provider:kubernetes", "resource:kubernetes-node", "created-by:terraform"], var.memory_pressure_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:caas", "provider:kubernetes", "resource:kubernetes-node", "created-by:terraform"], var.ready_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:caas", "provider:kubernetes", "resource:kubernetes-node", "created-by:terraform"], var.kubelet_ping_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:caas", "provider:kubernetes", "resource:kubernetes-node", "created-by:terraform"], var.kubelet_syncloop_extra_tags)
}
...
resource "datadog_monitor" "unregister_net_device" {
  ...
  tags = concat(["env:${var.environment}", "type:caas", "provider:kubernetes", "resource:kubernetes-node", "created-by:terraform"], var.unregister_net_device_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:caas", "provider:kubernetes", "resource:kubernetes-node", "created-by:terraform"], var.node_unschedulable_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:caas", "provider:kubernetes", "resource:kubernetes-node", "created-by:terraform"], var.volume_space_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:caas", "provider:kubernetes", "resource:kubernetes-node", "created-by:terraform"], var.volume_inodes_extra_tags)
}
