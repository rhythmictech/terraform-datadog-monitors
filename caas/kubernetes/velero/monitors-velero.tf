...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:caas", "provider:openmetrics", "resource:velero", "created-by:terraform"], var.velero_scheduled_backup_missing_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:caas", "provider:openmetrics", "resource:velero", "created-by:terraform"], var.velero_backup_failure_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:caas", "provider:openmetrics", "resource:velero", "created-by:terraform"], var.velero_backup_partial_failure_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:caas", "provider:openmetrics", "resource:velero", "created-by:terraform"], var.velero_backup_deletion_failure_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:caas", "provider:openmetrics", "resource:velero", "created-by:terraform"], var.velero_volume_snapshot_failure_extra_tags)
}
