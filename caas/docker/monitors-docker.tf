...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:docker", "provider:docker", "resource:docker", "created-by:terraform"], var.not_responding_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:docker", "provider:docker", "resource:docker", "created-by:terraform"], var.memory_used_extra_tags)
}
