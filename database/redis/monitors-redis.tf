...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:redisdb", "resource:redis", "created-by:terraform"], var.not_responding_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:redisdb", "resource:redis", "created-by:terraform"], var.evictedkeys_change_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:redisdb", "resource:redis", "created-by:terraform"], var.expirations_rate_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:redisdb", "resource:redis", "created-by:terraform"], var.blocked_clients_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:redisdb", "resource:redis", "created-by:terraform"], var.keyspace_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:redisdb", "resource:redis", "created-by:terraform"], var.mem_used_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:redisdb", "resource:redis", "created-by:terraform"], var.mem_frag_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:redisdb", "resource:redis", "created-by:terraform"], var.rejected_con_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:redisdb", "resource:redis", "created-by:terraform"], var.latency_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:redisdb", "resource:redis", "created-by:terraform"], var.hitrate_extra_tags)
}
