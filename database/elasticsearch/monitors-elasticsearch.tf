...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:elasticsearch", "resource:elasticsearch", "created-by:terraform"], var.not_responding_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:elasticsearch", "resource:elasticsearch", "created-by:terraform"], var.cluster_status_not_green_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:elasticsearch", "resource:elasticsearch", "created-by:terraform"], var.cluster_initializing_shards_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:elasticsearch", "resource:elasticsearch", "created-by:terraform"], var.cluster_relocating_shards_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:elasticsearch", "resource:elasticsearch", "created-by:terraform"], var.cluster_unassigned_shards_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:elasticsearch", "resource:elasticsearch", "created-by:terraform"], var.node_free_space_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:elasticsearch", "resource:elasticsearch", "created-by:terraform"], var.jvm_heap_memory_usage_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:elasticsearch", "resource:elasticsearch", "created-by:terraform"], var.jvm_memory_young_usage_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:elasticsearch", "resource:elasticsearch", "created-by:terraform"], var.jvm_memory_old_usage_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:elasticsearch", "resource:elasticsearch", "created-by:terraform"], var.jvm_gc_old_collection_latency_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:elasticsearch", "resource:elasticsearch", "created-by:terraform"], var.jvm_gc_young_collection_latency_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:elasticsearch", "resource:elasticsearch", "created-by:terraform"], var.indexing_latency_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:elasticsearch", "resource:elasticsearch", "created-by:terraform"], var.flush_latency_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:elasticsearch", "resource:elasticsearch", "created-by:terraform"], var.http_connections_anomaly_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:elasticsearch", "resource:elasticsearch", "created-by:terraform"], var.search_query_latency_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:elasticsearch", "resource:elasticsearch", "created-by:terraform"], var.fetch_latency_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:elasticsearch", "resource:elasticsearch", "created-by:terraform"], var.search_query_change_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:elasticsearch", "resource:elasticsearch", "created-by:terraform"], var.fetch_change_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:elasticsearch", "resource:elasticsearch", "created-by:terraform"], var.field_data_evictions_change_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:elasticsearch", "resource:elasticsearch", "created-by:terraform"], var.query_cache_evictions_change_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:elasticsearch", "resource:elasticsearch", "created-by:terraform"], var.request_cache_evictions_change_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:elasticsearch", "resource:elasticsearch", "created-by:terraform"], var.task_time_in_queue_change_extra_tags)
}
