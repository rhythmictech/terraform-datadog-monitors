...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:mysql", "resource:mysql", "created-by:terraform"], var.mysql_availability_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:mysql", "resource:mysql", "created-by:terraform"], var.mysql_connection_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:mysql", "resource:mysql", "created-by:terraform"], var.mysql_aborted_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:mysql", "resource:mysql", "created-by:terraform"], var.mysql_slow_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:mysql", "resource:mysql", "created-by:terraform"], var.mysql_pool_efficiency_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:mysql", "resource:mysql", "created-by:terraform"], var.mysql_pool_utilization_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:mysql", "resource:mysql", "created-by:terraform"], var.mysql_threads_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:mysql", "resource:mysql", "created-by:terraform"], var.mysql_questions_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:mysql", "resource:mysql", "created-by:terraform"], var.mysql_replication_lag_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:mysql", "resource:mysql", "created-by:terraform"], var.mysql_replication_status_extra_tags)
}
