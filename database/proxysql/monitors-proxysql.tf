...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:proxysql", "resource:proxysql", "created-by:terraform"], var.proxysql_thread_worker_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:proxysql", "resource:proxysql", "created-by:terraform"], var.proxysql_slow_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:proxysql", "resource:proxysql", "created-by:terraform"], var.proxysql_client_conn_aborted_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:proxysql", "resource:proxysql", "created-by:terraform"], var.proxysql_server_conn_aborted_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:proxysql", "resource:proxysql", "created-by:terraform"], var.proxysql_pool_conn_failure_extra_tags)
}
