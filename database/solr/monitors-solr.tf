...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:solr", "resource:solr", "created-by:terraform"], var.not_responding_extra_tags)
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:solr", "resource:solr", "created-by:terraform"], var.search_handler_errors_extra_tags)
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:solr", "resource:solr", "created-by:terraform"], var.searcher_warmup_time_extra_tags)
}
