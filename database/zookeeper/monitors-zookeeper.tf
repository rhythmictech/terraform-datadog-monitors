...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:zookeeper", "resource:zookeeper", "created-by:terraform"], var.zookeeper_latency_availability_extra_tags)
