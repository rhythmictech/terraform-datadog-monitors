...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:mongo", "resource:mongodb", "created-by:terraform"], var.mongodb_primary_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:mongo", "resource:mongodb", "created-by:terraform"], var.mongodb_secondary_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:database", "provider:mongo", "resource:mongodb", "created-by:terraform"], var.mongodb_replication_extra_tags)
}
