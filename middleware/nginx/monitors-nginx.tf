...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:middleware", "provider:nginx", "resource:nginx", "created-by:terraform"], var.nginx_connect_extra_tags)
}
...
EOQ
  ...
  tags = concat(["env:${var.environment}", "type:middleware", "provider:nginx", "resource:nginx", "created-by:terraform"], var.nginx_dropped_extra_tags)
}
